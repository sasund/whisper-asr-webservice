...
=== ":octicons-file-code-16: `CPU`"
    ...
    ```shell
    docker run -d -p 9000:9000 -e ASR_MODEL=base -e ASR_ENGINE=openai_whisper sasund/whisper-asr-webservice:latest
    ```
...
=== ":octicons-file-code-16: `GPU`"
    ...
    ```shell
    docker run -d --gpus all -p 9000:9000 -e ASR_MODEL=base -e ASR_ENGINE=openai_whisper sasund/whisper-asr-webservice:latest-gpu
    ```
